...
<template>
	...
	<div class="mb-3 d-flex justify-content-between flex-wrap search-bar fastuga-font">
		...
		<div class="mx-2 mt-2">
			<button type="button" class="btn px-4 btn-clear" @click="clear">Clear</button>
		</div>
	</div>
	<CustomersTable :customers="customers" @show="show" @delete="deleteFromDatabase" @block="block" @unblock="unblock">
	</CustomersTable>
